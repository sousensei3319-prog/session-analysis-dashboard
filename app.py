...
# 追補v5 §1: サンプルトレード生成の共通土台。2026-04-15〜2026-07-08(JST)の実市場価格
# (BTC/ETH/SOL=Binance spot 1h close, HYPE=Bybit linear perp 1h close, GOLD=Yahoo GC=F 1h close)
# を基にrandom.seed(42)で決定的に選定した行データを直接埋め込む(取得手順はscratchpad保管)。
...
def generate_sample_trades() -> pd.DataFrame:
    ...
    追補v5: 2026-04-15〜2026-07-08(JST、約2.8ヶ月)の実市場価格に基づく48件+draw1件=49件。
    全9詳細帯に最低3件・全7曜日を含み、Entry/Exit_Priceは実1時間足close±0.05%程度に一致させている。
    ペルソナ: 勝率46〜48%・平均勝ち<平均負け(低RR)。負けを欧州序盤(ロンドンオープン)・
    NY午前(NY重複)帯に意図的に集中させ、「負けやすい時間帯」の可視化デモに使う。
    """
    rows = [
        ("2026-04-16 06:22:00", "2026-04-16 12:22:00", "BTC", 23.49, 0.15, "win", "LONG", 5, 74758.05, 74873.23),
        ("2026-04-16 11:08:00", "2026-04-16 17:08:00", "BTC", -291.01, -0.32, "loss", "LONG", 23, 74909.71, 74670.44),
        ("2026-04-17 16:58:00", "2026-04-17 22:58:00", "SOL", -1471.45, -2.3, "loss", "SHORT", 22, 88.11, 90.14),
        ("2026-04-20 11:17:00", "2026-04-20 22:17:00", "GOLD", 305.88, 0.49, "win", "LONG", 25, 4814.26, 4837.83),
        ("2026-04-21 15:16:00", "2026-04-21 21:16:00", "SOL", -6.75, -0.14, "loss", "LONG", 6, 85.65, 85.53),
        ("2026-04-24 14:03:00", "2026-04-24 20:03:00", "BTC", 244.29, 0.4, "win", "LONG", 16, 77930.09, 78240.26),
        ("2026-04-25 07:55:00", "2026-04-25 19:55:00", "HYPE", -961.99, -1.46, "loss", "SHORT", 22, 41.2, 41.8),
        ("2026-04-27 11:32:00", "2026-04-27 18:32:00", "BTC", 192.13, 1.52, "win", "SHORT", 10, 79106.27, 77900.01),
        ("2026-04-29 16:55:00", "2026-04-30 00:55:00", "SOL", -1085.28, -1.68, "loss", "LONG", 25, 84.7, 83.28),
        ("2026-05-05 21:32:00", "2026-05-06 07:32:00", "HYPE", -89.53, -1.03, "loss", "SHORT", 4, 43.72, 44.17),
        ("2026-05-07 16:42:00", "2026-05-08 06:42:00", "BTC", -546.39, -2.16, "loss", "LONG", 17, 81518.58, 79758.93),
        ("2026-05-08 09:43:00", "2026-05-08 15:43:00", "ETH", 59.2, 0.48, "win", "SHORT", 7, 2286.37, 2275.45),
        ("2026-05-08 12:11:00", "2026-05-08 17:11:00", "ETH", 47.52, 0.24, "win", "LONG", 20, 2278.53, 2284.02),
        ("2026-05-08 14:10:00", "2026-05-08 22:10:00", "HYPE", -10.15, -0.19, "loss", "SHORT", 6, 42.3, 42.38),
        ("2026-05-10 05:55:00", "2026-05-10 10:55:00", "ETH", 81.9, 0.21, "win", "SHORT", 24, 2328.95, 2324.13),
        ("2026-05-12 19:38:00", "2026-05-13 01:38:00", "BTC", -352.37, -0.8, "loss", "LONG", 18, 80666.37, 80024.01),
        ("2026-05-13 02:10:00", "2026-05-13 03:00:00", "BTC", 0.0, 0.0, "draw", "LONG", 1, 80527.69, 80527.69),
        ("2026-05-13 06:03:00", "2026-05-13 14:03:00", "ETH", -107.7, -0.5, "loss", "SHORT", 20, 2286.09, 2297.53),
        ("2026-05-14 10:30:00", "2026-05-14 16:30:00", "SOL", -73.75, -0.35, "loss", "LONG", 8, 91.17, 90.85),
        ("2026-05-16 07:20:00", "2026-05-16 08:50:00", "HYPE", 66.02, 0.27, "win", "LONG", 11, 44.04, 44.16),
        ("2026-05-18 18:55:00", "2026-05-19 01:55:00", "GOLD", 38.8, 0.12, "win", "LONG", 9, 4547.45, 4553.03),
        ("2026-05-21 15:24:00", "2026-05-21 18:24:00", "HYPE", 2205.74, 2.48, "win", "LONG", 23, 56.49, 57.89),
        ("2026-05-24 01:48:00", "2026-05-24 11:48:00", "ETH", -1835.08, -2.91, "loss", "SHORT", 19, 2062.27, 2122.32),
        ("2026-05-24 03:16:00", "2026-05-24 11:16:00", "SOL", -170.01, -1.45, "loss", "SHORT", 7, 84.72, 85.95),
        ("2026-05-25 21:57:00", "2026-05-26 09:57:00", "BTC", -59.24, -0.71, "loss", "LONG", 4, 77352.51, 76800.39),
        ("2026-05-27 06:35:00", "2026-05-27 12:35:00", "BTC", -99.76, -0.24, "loss", "LONG", 15, 75890.0, 75705.7),
        ("2026-05-27 07:28:00", "2026-05-27 11:28:00", "HYPE", 365.7, 1.68, "win", "LONG", 8, 59.7, 60.7),
        ("2026-05-27 21:58:00", "2026-05-28 09:58:00", "BTC", -596.27, -1.52, "loss", "LONG", 12, 75695.57, 74548.29),
        ("2026-05-30 06:34:00", "2026-05-30 16:34:00", "SOL", -127.89, -0.84, "loss", "SHORT", 5, 81.69, 82.38),
        ("2026-05-30 08:00:00", "2026-05-30 11:00:00", "SOL", 129.74, 1.17, "win", "LONG", 13, 82.04, 83.0),
        ("2026-06-02 16:38:00", "2026-06-02 22:38:00", "GOLD", -102.68, -0.76, "loss", "LONG", 10, 4565.66, 4530.74),
        ("2026-06-06 05:48:00", "2026-06-06 10:48:00", "HYPE", 95.46, 0.25, "win", "LONG", 12, 59.42, 59.57),
        ("2026-06-10 18:48:00", "2026-06-11 00:48:00", "BTC", -884.07, -2.16, "loss", "SHORT", 21, 61328.81, 62651.76),
        ("2026-06-11 02:37:00", "2026-06-11 07:37:00", "SOL", 65.93, 1.95, "win", "SHORT", 3, 64.03, 62.78),
        ("2026-06-13 20:50:00", "2026-06-14 06:50:00", "BTC", -273.15, -0.74, "loss", "SHORT", 24, 63984.07, 64458.15),
        ("2026-06-14 17:11:00", "2026-06-14 23:11:00", "BTC", -329.22, -0.77, "loss", "LONG", 21, 64475.67, 63977.15),
        ("2026-06-16 04:08:00", "2026-06-16 07:08:00", "ETH", 123.3, 1.74, "win", "SHORT", 2, 1821.71, 1790.04),
        ("2026-06-18 01:58:00", "2026-06-18 09:58:00", "ETH", -128.31, -1.05, "loss", "LONG", 13, 1771.49, 1752.97),
        ("2026-06-19 09:10:00", "2026-06-19 17:10:00", "ETH", -231.02, -0.97, "loss", "LONG", 17, 1714.35, 1697.77),
        ("2026-06-19 23:25:00", "2026-06-20 06:25:00", "HYPE", 228.64, 0.86, "win", "LONG", 14, 68.75, 69.34),
        ("2026-06-20 14:21:00", "2026-06-21 02:21:00", "SOL", -26.27, -0.38, "loss", "LONG", 2, 71.81, 71.54),
        ("2026-06-21 01:29:00", "2026-06-21 07:29:00", "ETH", 368.87, 0.57, "win", "LONG", 19, 1733.92, 1743.84),
        ("2026-06-22 04:36:00", "2026-06-22 08:36:00", "BTC", 607.46, 1.43, "win", "SHORT", 18, 64226.38, 63305.66),
        ("2026-06-22 13:01:00", "2026-06-22 17:01:00", "GOLD", 12.75, 0.35, "win", "LONG", 3, 4200.24, 4214.86),
        ("2026-06-24 06:28:00", "2026-06-24 11:28:00", "HYPE", 200.41, 0.79, "win", "SHORT", 14, 62.06, 61.57),
        ("2026-06-28 05:20:00", "2026-06-28 11:20:00", "ETH", 188.78, 0.57, "win", "SHORT", 9, 1581.16, 1572.16),
        ("2026-06-30 15:58:00", "2026-06-30 21:58:00", "GOLD", -132.13, -0.52, "loss", "LONG", 11, 4043.9, 4022.69),
        ("2026-07-06 18:23:00", "2026-07-06 23:23:00", "SOL", 173.07, 0.29, "win", "LONG", 16, 80.08, 80.31),
        ("2026-07-07 00:23:00", "2026-07-07 07:23:00", "BTC", 484.43, 1.13, "win", "LONG", 15, 63526.92, 64244.0),
    ]
...
def generate_sample_trades_mentor() -> pd.DataFrame:
    ...
    (固定データ、乱数不使用で完全再現)。追補v5。

    弟子サンプル(generate_sample_trades)と同期間(2026-04-15〜2026-07-08)・同銘柄群
    (BTC/ETH/SOL/HYPE/GOLD)・全9詳細帯に分散という条件を揃えつつ、56件・勝率56〜58%・
    平均勝ち>平均負け(高RR)で、勝率/プロフィットファクター/損益分布が明確に良い実データを使う。
    師弟比較ビューの実演データ用。
    """
    rows = [
        ("2026-04-17 08:06:00", "2026-04-17 14:06:00", "HYPE", 122.0, 0.73, "win", "SHORT", 8, 43.8, 43.48),
        ("2026-04-18 11:01:00", "2026-04-18 17:01:00", "HYPE", 76.88, 0.38, "win", "SHORT", 6, 45.15, 44.98),
        ("2026-04-19 09:21:00", "2026-04-19 15:21:00", "HYPE", 127.22, 0.46, "win", "SHORT", 21, 43.64, 43.44),
        ("2026-04-20 15:27:00", "2026-04-20 20:27:00", "BTC", -105.21, -0.57, "loss", "SHORT", 11, 74779.11, 75207.75),
        ("2026-04-22 21:18:00", "2026-04-23 02:18:00", "HYPE", 231.0, 0.73, "win", "SHORT", 12, 41.16, 40.86),
        ("2026-04-26 04:56:00", "2026-04-26 14:56:00", "SOL", 250.61, 0.85, "win", "LONG", 21, 85.69, 86.42),
        ("2026-04-26 18:17:00", "2026-04-27 06:17:00", "SOL", 167.85, 0.36, "win", "LONG", 25, 86.55, 86.86),
        ("2026-04-28 16:04:00", "2026-04-29 02:04:00", "HYPE", 482.72, 2.22, "win", "SHORT", 24, 40.59, 39.69),
        ("2026-04-29 03:08:00", "2026-04-29 05:08:00", "BTC", -51.25, -0.32, "loss", "SHORT", 8, 76234.56, 76479.24),
        ("2026-04-30 05:54:00", "2026-04-30 08:54:00", "GOLD", -33.22, -0.39, "loss", "SHORT", 7, 4557.3, 4575.17),
        ("2026-05-02 01:17:00", "2026-05-02 03:47:00", "GOLD", -108.86, -0.35, "loss", "LONG", 18, 4651.07, 4634.71),
        ("2026-05-02 04:36:00", "2026-05-02 07:06:00", "BTC", -91.8, -0.3, "loss", "LONG", 12, 78375.67, 78137.75),
        ("2026-05-02 15:38:00", "2026-05-02 20:38:00", "ETH", -15.03, -0.19, "loss", "LONG", 7, 2306.27, 2301.87),
        ("2026-05-03 10:22:00", "2026-05-03 15:22:00", "HYPE", 106.46, 0.34, "win", "SHORT", 21, 41.09, 40.95),
        ("2026-05-04 21:31:00", "2026-05-05 02:31:00", "ETH", 748.48, 1.51, "win", "LONG", 16, 2335.06, 2370.33),
        ("2026-05-05 06:02:00", "2026-05-05 12:02:00", "SOL", 225.32, 0.45, "win", "LONG", 22, 84.4, 84.78),
        ("2026-05-08 17:21:00", "2026-05-09 01:21:00", "ETH", 58.76, 0.31, "win", "LONG", 14, 2283.33, 2290.39),
        ("2026-05-09 06:07:00", "2026-05-09 09:07:00", "SOL", -38.0, -0.23, "loss", "SHORT", 14, 92.28, 92.49),
        ("2026-05-11 13:41:00", "2026-05-11 18:41:00", "BTC", -156.25, -0.21, "loss", "SHORT", 23, 80800.36, 80966.57),
        ("2026-05-14 16:05:00", "2026-05-14 21:05:00", "ETH", 35.27, 0.22, "win", "SHORT", 17, 2265.93, 2261.03),
        ("2026-05-15 08:59:00", "2026-05-15 20:59:00", "SOL", 274.32, 1.0, "win", "SHORT", 9, 92.18, 91.26),
        ("2026-05-19 22:10:00", "2026-05-20 03:10:00", "HYPE", 186.98, 0.56, "win", "SHORT", 15, 48.45, 48.18),
        ("2026-05-25 02:04:00", "2026-05-25 08:04:00", "BTC", 33.21, 0.51, "win", "LONG", 4, 76670.33, 77064.96),
        ("2026-05-26 01:05:00", "2026-05-26 13:05:00", "BTC", 1000.92, 1.31, "win", "SHORT", 23, 77743.46, 76726.48),
        ("2026-05-28 12:24:00", "2026-05-28 17:24:00", "ETH", 102.71, 0.3, "win", "LONG", 18, 1981.95, 1987.86),
        ("2026-05-29 06:15:00", "2026-05-29 12:15:00", "BTC", 48.92, 0.67, "win", "SHORT", 7, 73809.93, 73316.18),
        ("2026-05-30 07:38:00", "2026-05-30 19:38:00", "BTC", 97.0, 0.19, "win", "LONG", 19, 73490.87, 73633.75),
        ("2026-06-05 15:40:00", "2026-06-05 21:40:00", "GOLD", 802.12, 1.1, "win", "SHORT", 20, 4480.15, 4430.77),
        ("2026-06-06 23:02:00", "2026-06-07 04:02:00", "BTC", -42.23, -0.35, "loss", "LONG", 5, 60809.29, 60593.95),
        ("2026-06-07 08:15:00", "2026-06-07 11:15:00", "SOL", -976.2, -2.14, "loss", "SHORT", 13, 62.21, 63.54),
        ("2026-06-08 07:21:00", "2026-06-08 12:21:00", "SOL", -98.69, -0.85, "loss", "SHORT", 3, 65.81, 66.37),
        ("2026-06-10 16:52:00", "2026-06-11 00:52:00", "BTC", 178.18, 1.57, "win", "LONG", 3, 61687.56, 62658.02),
        ("2026-06-11 21:28:00", "2026-06-11 22:58:00", "SOL", -328.5, -0.44, "loss", "SHORT", 20, 65.25, 65.54),
        ("2026-06-13 17:41:00", "2026-06-13 21:41:00", "BTC", -37.88, -0.47, "loss", "SHORT", 10, 63825.14, 64126.71),
        ("2026-06-14 18:57:00", "2026-06-14 20:57:00", "HYPE", -78.65, -0.33, "loss", "SHORT", 24, 60.82, 61.02),
        ("2026-06-15 02:06:00", "2026-06-15 07:06:00", "HYPE", -785.81, -5.4, "loss", "SHORT", 17, 59.77, 63.0),
        ("2026-06-15 18:04:00", "2026-06-15 23:04:00", "ETH", 316.85, 5.61, "win", "LONG", 2, 1718.65, 1815.09),
        ("2026-06-16 13:40:00", "2026-06-16 16:10:00", "ETH", -189.22, -0.73, "loss", "SHORT", 24, 1760.82, 1773.71),
        ("2026-06-17 05:47:00", "2026-06-17 08:47:00", "BTC", -78.41, -0.24, "loss", "LONG", 18, 65840.83, 65681.58),
        ("2026-06-17 19:15:00", "2026-06-17 20:45:00", "GOLD", -21.25, -0.17, "loss", "LONG", 5, 4351.1, 4343.9),
        ("2026-06-18 05:47:00", "2026-06-18 07:47:00", "BTC", -43.75, -0.25, "loss", "LONG", 11, 64447.25, 64287.15),
        ("2026-06-18 14:18:00", "2026-06-19 02:18:00", "SOL", 627.93, 3.54, "win", "SHORT", 14, 71.15, 68.63),
        ("2026-06-18 15:57:00", "2026-06-18 23:57:00", "HYPE", 151.37, 2.6, "win", "SHORT", 2, 71.14, 69.29),
        ("2026-06-19 10:04:00", "2026-06-19 11:34:00", "GOLD", -84.15, -0.18, "loss", "LONG", 13, 4202.18, 4194.74),
        ("2026-06-21 06:05:00", "2026-06-21 14:05:00", "BTC", 216.09, 0.41, "win", "LONG", 19, 63999.6, 64262.98),
        ("2026-06-23 09:16:00", "2026-06-23 11:16:00", "HYPE", -582.24, -1.12, "loss", "SHORT", 22, 66.29, 67.03),
        ("2026-06-24 01:15:00", "2026-06-24 09:15:00", "BTC", 351.62, 0.69, "win", "LONG", 16, 62570.51, 63001.4),
        ("2026-06-25 06:56:00", "2026-06-25 18:56:00", "ETH", 844.24, 1.73, "win", "LONG", 25, 1620.88, 1648.88),
        ("2026-07-01 04:59:00", "2026-07-01 08:59:00", "BTC", -96.25, -0.3, "loss", "LONG", 15, 58806.29, 58630.57),
        ("2026-07-01 22:51:00", "2026-07-02 03:51:00", "BTC", 211.62, 1.09, "win", "LONG", 11, 59515.88, 60165.14),
        ("2026-07-03 19:09:00", "2026-07-04 01:09:00", "ETH", 180.32, 0.46, "win", "SHORT", 10, 1741.99, 1733.98),
        ("2026-07-03 19:52:00", "2026-07-04 00:52:00", "ETH", 36.98, 0.6, "win", "SHORT", 4, 1742.16, 1731.76),
        ("2026-07-05 10:46:00", "2026-07-05 18:46:00", "ETH", 30.82, 0.53, "win", "SHORT", 4, 1767.15, 1757.8),
        ("2026-07-06 06:28:00", "2026-07-06 12:28:00", "SOL", 249.05, 1.2, "win", "SHORT", 6, 81.8, 80.82),
        ("2026-07-07 15:56:00", "2026-07-07 20:56:00", "GOLD", -310.95, -0.61, "loss", "SHORT", 25, 4142.11, 4167.35),
        ("2026-07-07 17:49:00", "2026-07-07 22:49:00", "SOL", -133.25, -0.5, "loss", "LONG", 9, 81.27, 80.86),
    ]
    return _sample_rows_to_df(rows)
...
@st.cache_data(ttl=HOURLY_CACHE_TTL_SEC, show_spinner=False, persist="disk")
...
@st.cache_data(ttl=MINUTE_CACHE_TTL_SEC, show_spinner=False, persist="disk")
...
@st.cache_data(ttl=FINE_CACHE_TTL_SEC, show_spinner=False, persist="disk")
...
@st.cache_data(ttl=DAILY_CACHE_TTL_SEC, show_spinner=False, persist="disk")
...
def _add_exit_and_link_traces(fig: go.Figure, mapped: pd.DataFrame, ds_label: str, row: int) -> None:
    ...
    for _, r in em.iterrows():
        ...
        exit_hover.append(
            ...
            f"PnL {pnl_lbl} ({pct_lbl})<br>保有時間: {hold_lbl}"
        )
    fig.add_trace(
        go.Scatter(
...
def add_trade_overlay_traces(
    ...
    for ov in overlays:
        ...
        _add_exit_and_link_traces(fig, mapped, ds_label, row)
    return total_drawn
...
def render_trade_zoom_section(
    ...
    if st.session_state.get("zoom_ds_select") not in ds_labels:
        st.session_state["zoom_ds_select"] = ds_labels[0]
    zoom_ds_label = (
        st.selectbox("データセット", ds_labels, key="zoom_ds_select") if len(ds_labels) > 1 else ds_labels[0]
    )

    trades_df = trade_datasets[zoom_ds_label]["trades_assigned"]
    options = build_zoom_trade_options(trades_df)
    if not options:
    ...
    chosen_label = st.selectbox("トレードを選択", option_labels, key=sel_key)
    chosen_idx = dict(options)[chosen_label]
    ...
    overlay_color = get_trade_marker_color(zoom_ds_label, 0)
    add_trade_overlay_traces(
        fig, ohlcv_df,
        [{"dataset_label": zoom_ds_label, "trades_df": single_row_df, "color": overlay_color}],
        None, row=1,
    )
